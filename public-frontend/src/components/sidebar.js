...
function SidebarMenu() {
  ...
  return(
          <div id="SideBar">
              ...
              <div id="sideBar" className="d-flex flex-column flex-shrink-0 p-2 text-white">
              ...
              <ul className="nav nav-pills flex-column mb-auto mt-1">
                  <li>
                      <a href="#" className={`nav-link ${location.pathname === "/Offers" || location.pathname=== "/Leaderboard" || location.pathname === "/Betify" ? "Selected nav-link text-white mb-1 fw-semibold d-flex justify-content-between fs-7 align-items-center" : "nav-link text-white mb-1 fw-semibold d-flex justify-content-between fs-7 align-items-center"}`}  data-bs-toggle="collapse" data-bs-target="#home-collapse" aria-expanded="false">
                      Casinos
                      <Icon.ChevronDown/>
                      </a>
                      <div className="collapse show" id="home-collapse">
                          <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                              <li>
                                  <Link as={Link} onClick={progressBar} className={`nav-link ${location.pathname === "/Offers" ? "nav-link text-white ms-4 fs-7 mb-1 active BadgeFix" : "nav-link text-white ms-4 fs-7 mb-1 BadgeFix"}`} to="/Offers">
                              ...
                              <li>
                                  <Link as={Link} onClick={progressBar} className={`nav-link ${location.pathname === "/Betify" ? "nav-link text-white ms-4 fs-7 active BadgeFix" : "nav-link text-white ms-4 fs-7 BadgeFix"}`} to="/Betify">
                              ...
                              <li>
                                  <Link as={Link} onClick={progressBar} className={`nav-link ${location.pathname === "/Leaderboard" ? "nav-link text-white ms-4 fs-7 active BadgeFix" : "nav-link text-white ms-4 fs-7 BadgeFix"}`} to="/Leaderboard">
                  ...
                  <li>
                      ...
                      <div className="collapse" id="stream">
                          <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                          <li><Link as={Link} onClick={progressBar} className={`nav-link ${location.pathname === "/Live" ? "nav-link text-white ms-4 fs-7 active BadgeFix" : "nav-link text-white ms-4 fs-7 BadgeFix"}`} to="/Live">
          ...
          <a
            ...
            <div className="collapse show" id="miniGames">
              {/* <MiniGames /> */}
              <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small">
              
              <li>
                  <Link as={Link} onClick={progressBar} className={`nav-link ${ location.pathname === "/BonusHuntChallenge" ? "nav-link text-white ms-4 fs-7 active BadgeFix" : "nav-link text-white ms-4 fs-7 BadgeFix"}`} to="/BonusHuntChallenge">
                    <BHCIcon />
                    Bonus Hunt Challenge
                  </Link>
                </li>
                <li>
                  <Link as={Link} onClick={progressBar} className={`nav-link ${ location.pathname === "/BonusHunt" ? "nav-link text-white ms-4 fs-7 active BadgeFix" : "nav-link text-white ms-4 fs-7 BadgeFix"}`} to="/BonusHunt">
                    <Icon.Bullseye size={18} className="me-1" />
                    Bonus Hunt
                  </Link>
                </li>
                <li>
                <Link as={Link} onClick={progressBar} className={`nav-link ${ location.pathname === "/BonusBuyBattle" ? "nav-link text-white ms-4 fs-7 active BadgeFix" : "nav-link text-white ms-4 fs-7 BadgeFix"}`} to="/BonusBuyBattle">
                <svg
                ...
                <li>
                <Link as={Link} onClick={progressBar} className={`nav-link ${ location.pathname === "/Tournaments" ? "nav-link text-white ms-4 fs-7 active BadgeFix" : "nav-link text-white ms-4 fs-7 BadgeFix"}`} to="/Tournaments">
                <Icon.Trophy size={18} className="me-1" />
                    Tournaments
                  </Link>
                </li>
                <li>
                <Link as={Link} onClick={progressBar} className={`nav-link ${ location.pathname === "/KingOfTheHill" ? "nav-link text-white ms-4 fs-7 active BadgeFix" : "nav-link text-white ms-4 fs-7 BadgeFix"}`} to="/KingOfTheHill">
                <svg
                      xmlns="http://www.w3.org/2000/svg"
                      stroke="currentColor"
                      strokeLinecap="round"
          ...
          <li>
            <a
              href="#"
              className="nav-link text-white disabled opacity-50 mb-1 fw-semibold fs-7"
            >
